...
INPUT_DIR="test/test_file"           # Directory containing test input files
OUTPUT_DIR="test/encrypted_files"     # Directory for storing output files
DECRYPTED_DIR="test/decrypted_files"  # Directory for storing decrypted files
KEY_FILE="key.txt"
IV_FILE="iv.txt"
LOG_FILE="log.txt"
...
echo "ratata1293819203" > "$KEY_FILE"
